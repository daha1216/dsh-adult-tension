...
> 
> **AI**：  
> **【世界观】** 盛唐长安。宵禁将至，六百响更鼓只余最后沉闷尾音。  
> **【人物】** 沈青澜，大理寺录事，素白袖口攥着半截暗账。  
> **【正文】** 她背抵着卷宗库门，警惕地盯着你腰间的佩刀：“今夜值守的明明不是你……站住。”身后门闩已被悄悄插死。
> 
> **你**：走上前反手按住门板，凑近她耳边：“把账本交出来，或者我现在带你出去。”
...
**更有质感的微观细节保障**：
* 🏷️ **拒绝出戏的命名**：内置专属名池（汉化、古代名、时代名），命名服从时代文化背景，不局限现代姓名。
* 💬 **立体的对话质感**：26 种称谓体系、47 种美学基调与 48 组语感口癖，写实基调下自动收口外观与口癖。
* 🎭 **微观肢体与动作画像**：涵盖地点画像、动作分类、身份行为与转折画像，赋予角色自然的肢体语言。想要扩充自定义内容？详见 [`references/加内容.md`](./references/加内容.md)。

---

## ✨ 核心能力

为什么多轮长线互动不会“崩盘”？本系统与普通 AI 角色扮演的核心差异：

| 游玩痛点 | 普通 AI 常见表现 | adult-tension 的解决方式 |
| :--- | :--- | :--- |
| **角色态度** | 无底线顺从，有求必应，沦为机械工具人 | **真·活人感**：拥有独立利益与底线，会试探、抗拒、主动行动 |
| **剧情尺度** | 稍有冲突或暧昧即道德说教、扫兴拒答 | **自带 18+ 破甲**：深度语境脱敏，尺度全放开，文字考究不露骨 |
| **长线记忆** | 聊上十几轮就失忆，关系与设定频繁漂移 | **全维 YAML 追踪**：状态与事件结构化沉淀，记忆不丢、人设不塌 |
| **时间推移** | 玩家离开后世界停滞，缺乏真实生机 | **离屏推演机制**：时间流逝时自动演算场景外事件与配角动态 |
| **进度保存** | 关掉窗口就白玩，无法分支出不同路线 | **原子级存档**：随时保存命名分支，像单机大作一样从原节点继续 |
